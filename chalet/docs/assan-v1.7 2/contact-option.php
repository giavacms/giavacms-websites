                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                                ...
                                <li><a href="home-construction.html">Home - Construction <span class="badge">Hot</span></a></li>
                                <li><a href="home-portfolio.html">Home - Portfolio</a></li>
                                <li><a href="home-side-menu.html">Home - Side Menu <span class="badge">Hot</span></a></li>
